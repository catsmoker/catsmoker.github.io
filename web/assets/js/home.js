...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // --- "Show More/Less" Video Logic ---
    const SELECTORS_VIDEOS = { // Renamed for clarity
    ...
    document.addEventListener('click', function(e) {
        ...
        toggleVideoContent(contentToToggle, showMoreBtn, baseShowMoreText); // Renamed function
    });

    function toggleVideoContent(content, button, baseShowMoreText) { // Renamed function
    ...
    const Addresses_Crypto = { // Renamed for clarity
    ...
    if (addressSelect_Crypto) { 
        addressSelect_Crypto.addEventListener('change', updateDynamicAddress); // Added event listener
        updateDynamicAddress(); // Initial call
    }
    ...
    // --- Smooth scroll for internal links in nav ---
